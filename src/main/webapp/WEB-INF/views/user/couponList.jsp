      ...
      <div class="center__container d-flex justify-content-center">
        ...
        <div class="myPage__container pl-5">
          ...
          <div class="row myPage-content d-flex">
            ...
            <div class="col-3 list-items d-flex justify-content-between align-items-center mb-3">
              <div class="coupon">
                <img src="${pageContext.request.contextPath}/imgs/coupon-frame.png" alt="" width="200px">
                <p class="discount-rate">${coupon.discount}%</p>
                <p class="pl-2">
                  <span style="font-weight: bold;">[${coupon.coupon_name}]</span><br>
                  <span style="font-weight: bold;" class="useState">
                  	<c:choose>
                  		<c:when test="${coupon.use_check == 1}">
                  			사용가능
                  		</c:when>
                  		<c:otherwise>
                  			사용불가
